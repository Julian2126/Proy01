...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-blue-400 overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            @endif
            <button wire:click="create()" class="bg-purple-500 hover:bg-purple-700 text-black font-bold py-2 px-4 rounded my-3">Crear Nuevo Estudiante</button>
            @if($isOpen)
